<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcuseContrato.aspx.cs" Inherits="INDAABIN.DI.CONTRATOS.Aplicacion.Contrato.AcuseContrato" %>
<!DOCTYPE html>
    ...
    <table style="width: 100%">
        ...
        <tr id="EncabezadoNuevo" style="##Nuevo##">
                <td colspan="2">
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                <img src="https://sistemas.indaabin.gob.mx/ImagenesComunes/Hacienda-Indaabin-Zapata-2019.png" alt="" style="height: 60px; width: 550px"/></td>
                            <td style="text-align: right;">Dirección General de Política y Gestión  Inmobiliaria<br />
                                Dirección de Planeación Inmobiliaria<br />
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>ACUSE DE REGISTRO DE CONTRATO DE ARRENDAMIENTO</strong><br />
            </div>
                ...
                <div>
                    ...
                    <div style="text-align: justify;">
                        <p style="text-align: justify">
                            <span>Con fundamento en lo dispuesto en los numerales 110 Bis, 144 y 146 del &#39;Acuerdo por el que se establecen las disposiciones en Materia de Recursos Materiales y Servicios Generales&#39;, publicado en el Diario Oficial de la Federación el día 5 de abril de 2016; y de acuerdo a la información capturada en el Sistema de Contratos de Arrendamiento y Otras Figuras de Ocupación de este Instituto, se emite el acuse de captura de Contrato de Arredamiento, de la Institución Pública que usted representa; debiéndose observar la normatividad aplicable. </span>
                        </p>
                        <br />
                        <div class="row">
                            <div class="col-md-12">
