...
{
    public partial class AcuseContrato : System.Web.UI.Page
    {
        String Msj;
            ...
            if (ConversionOK)
            {
                try
                {
                    ...
                    if (objAcuseContrato != null)
                    {
                        ...
                        this.LabelDeclaracionAnio.Text = string.Empty;
                        ...
                        if (objAcuseContrato.ContratoArrto.DescripcionTipoContrato == "Otras Figuras de Ocupación")
                        {
        ...
        protected void ButtonExportarPdf_Click(object sender, EventArgs e)
        {
            ...
            if (ConversionOK)
            {
                ...
                strCuerpoFormateado = strCuerpoFormateado.Replace("src=\"http://sistemas.indaabin.gob.mx/ImagenesComunes/INDAABIN_01.jpg\"", "src=\"https://sistemas.indaabin.gob.mx/ImagenesComunes/Hacienda-Indaabin-Zapata-2019.png\"");
