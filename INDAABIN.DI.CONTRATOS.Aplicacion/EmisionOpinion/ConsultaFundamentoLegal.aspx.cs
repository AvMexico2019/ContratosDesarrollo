...
{
    public partial class ConsultaFundamentoLegal : System.Web.UI.Page
    {
        String Msj;
        ...
        private void MostrarFundamento()
        {
            ...
            string IdTema = Request.QueryString["TemaOpinion"];
            ...
            objConceptoRespValor = new NGConceptoRespValor().ObtenerFundamentoLegalCpto(Convert.ToByte(IdTema), Convert.ToDecimal(NumOrdenConcepto));
