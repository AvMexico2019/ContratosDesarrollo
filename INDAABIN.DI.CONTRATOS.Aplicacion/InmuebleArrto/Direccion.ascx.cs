...
namespace INDAABIN.DI.CONTRATOS.Aplicacion.InmuebleArrto
{
    public partial class Direccion : System.Web.UI.UserControl
    {
        ...
        private void CargaInicialGeoreferencia()
        {
        ...
        private Boolean PoblarDropDownListaTipoInmueble()
        {
            ...
            try
            {
                this.DropDownListTipoInmueble.Items.Clear();
                //obtener informacion de paises del BUS, si la lista ya existe solo obtenerla, sino cargarla del BUS                        
        ...
        {
            this.DropDownListColonia.DataTextField = "DescripcionComp";
            //this.DropDownListColonia.DataTextField = "Descripcion";
            this.DropDownListColonia.DataValueField = "IdCatalogo";
        ...
        public void DefineVisibilidadPanelesPorPais()
        {
            ...
            if (DropDownListPais.SelectedItem.Text == "México")
            {
                ...
                //this.rfvTextBoxLatitud.Enabled = true;
                //this.rfvTextBoxLongitud.Enabled = true;
                this.pnlControlesGeo.Visible = true;
            }
            else
            {
                this.PanelNacional.Visible = false;
                this.PanelExtranjero.Visible = true;
                //this.rfvTextBoxLatitud.Enabled = false;
                //this.rfvTextBoxLongitud.Enabled = false;
                this.pnlControlesGeo.Visible = false;
            }
        }
