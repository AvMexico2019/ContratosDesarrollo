<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="BusqMvtosContratosInmuebles.aspx.cs" Inherits="INDAABIN.DI.CONTRATOS.Aplicacion.InmuebleArrto.BusqMvtosContratosInmuebles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanelBusqMvtosContratosInmueble" runat="server">
        <ContentTemplate>
            <br />
            <br />             
            <br />
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Contratos de arrendamiento de inmuebles </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" tooltip="Da clic para consultar los registros de contrato de arrendamiento" type="button" runat="server" validationgroup="CamposBusqueda" onserverclick="ButtonConsultar_Click"><span class="glyphicon glyphicon-search"></span>Consultar</button>
                                </div>
                            </div>
                        </div>
                        <p>
                            ...
                            <div class =" table-responsive">
                                <asp:GridView ID="GridViewResult" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" OnRowCommand="GridViewResult_RowCommand" Font-Size="Small" OnRowCreated="GridViewResult_RowCreated" OnRowDataBound="GridViewResult_RowDataBound" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridViewResult_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ContratoArrtoInmueble.FolioContratoArrto" HeaderText="Folio contrato arrendamiento">
                                            <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="ContratoArrtoInmueble.RIUF" HeaderText="RIUF" ItemStyle-Width="150px" />
                                        <asp:BoundField DataField="ContratoArrtoInmueble.ObservacionesContratosReferencia" HeaderText="Observaciones" />
                                        <asp:TemplateField HeaderText="Operaciones de contrato de arrendamiento:">
                                            <ItemTemplate>
    ...
    <asp:UpdateProgress ID="UpdateProgressBusqMvtosContratosInmueble" runat="server" DisplayAfter="0" AssociatedUpdatePanelID="UpdatePanelBusqMvtosContratosInmueble">
        <ProgressTemplate>
            <div class="overlay" />
