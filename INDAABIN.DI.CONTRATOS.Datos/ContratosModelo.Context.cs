...
namespace INDAABIN.DI.CONTRATOS.Datos
{
    ...
    public partial class ArrendamientoInmuebleEntities : DbContext
    {
        ...
        public virtual DbSet<VW_DWH_CONTRATORIUF> VW_DWH_CONTRATORIUF { get; set; }
        public virtual DbSet<VW_DWH_RIUF> VW_DWH_RIUF { get; set; }
        public virtual DbSet<Vw_QlikContratoArren> Vw_QlikContratoArren { get; set; }
    
        [DbFunction("ArrendamientoInmuebleEntities", "SPLIT")]
        ...
        public virtual ObjectResult<spuSelecInformacionRIUFHabilitaroDeshabilitar_Result> spuSelecInformacionRIUFHabilitaroDeshabilitar(Nullable<System.DateTime> fechaInicio, Nullable<System.DateTime> fechaFin, Nullable<int> fk_IdInstitucion, string rIUF, Nullable<int> fk_IdPais, Nullable<int> fk_IdEstado, Nullable<int> fK_IdMunicipio, string codigoPostal, Nullable<int> tipoRegistro, Nullable<int> habilitaroDeshabilitar, Nullable<int> folioContrato)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spuSelecInformacionRIUFHabilitaroDeshabilitar_Result>("spuSelecInformacionRIUFHabilitaroDeshabilitar", fechaInicioParameter, fechaFinParameter, fk_IdInstitucionParameter, rIUFParameter, fk_IdPaisParameter, fk_IdEstadoParameter, fK_IdMunicipioParameter, codigoPostalParameter, tipoRegistroParameter, habilitaroDeshabilitarParameter, folioContratoParameter);
        }
        ...
        public virtual ObjectResult<spuSelectMvtosContratosParaInmueblesArrto_Result> spuSelectMvtosContratosParaInmueblesArrto(Nullable<int> otrasFiguras, Nullable<int> idInstitucion, Nullable<int> folioContratoArrto, Nullable<int> idPais, Nullable<int> idEstado, Nullable<int> idMunicipio, string rIUF)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spuSelectMvtosContratosParaInmueblesArrto_Result>("spuSelectMvtosContratosParaInmueblesArrto", otrasFigurasParameter, idInstitucionParameter, folioContratoArrtoParameter, idPaisParameter, idEstadoParameter, idMunicipioParameter, rIUFParameter);
        }
